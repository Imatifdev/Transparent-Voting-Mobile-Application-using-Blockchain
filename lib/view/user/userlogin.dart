  ...
  Widget build(BuildContext context) {
    void _submitForm() {
      if (_formKey.currentState!.validate()) {
        // Perform UserLogin or further actions
        String email = _email.text;
        String password = _id.text;

        // Process the UserLogin credentials
                  ...
                  onTap: _isLoggingIn
                      ...
                      : () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            bool isLoggedIn =
                                await _loginVM.login(_email.text, _id.text);
                            setState(() {
                              _isLoggingIn = false;
                            });
                            if (!isLoggedIn) {
                              ...
                              Navigator.pushAndRemoveUntil(
                                  context,
                                  MaterialPageRoute(
                                      builder: (ctx) => Home(isAdmin: false)),
